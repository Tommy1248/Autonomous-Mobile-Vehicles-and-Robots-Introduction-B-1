...
Function TaskI_Alignment_Token
    ...
    Go XY(18, 15, -6.8, 0, 0, 0) -Z(20) /2
	Go XY(18, 15, -6.8, 0, 0, 0) /2
	Move XY(18, 15, -6.8, 0, 0, 0) +X(5) /2
	Off 12
	Wait .05
	Move XY(18, 15, -6.3, 0, 0, 0) +Y(-1) +X(5) -Z(5) /2 CP
	Go XY(18, 15, -6.3, 0, 0, 0) +Y(-1) +X(1.5) -Z(5) /2
	Move XY(18, 15, -6.3, 0, 0, 0) +Y(-1) +X(1.5) +Z(1) /2
	On 12
	Wait .05
	Move XY(18, 15, -6.3, 0, 0, 0) +Y(-1) +X(1.5) -Z(20) /2
...
Function TaskI_Place_Tray_Token
    ...
    If TaskI_Tokens = 2 Then
    	Go XY(11.95, 26.5, -1, 0, 0, 0) +X(-0.8) +Y(-1 + TaskI_Tray_interval * TaskI_Tokens) -Z(20) /4 CP
        Move XY(11.95, 26.5, -1, 0, 0, 0) +X(-0.8) +Y(-1 + TaskI_Tray_interval * TaskI_Tokens) /4
        Off 12
        Wait .1
        Go XY(11.95, 26.5, -1, 0, 0, 0) +X(-0.8) +Y(-1 + TaskI_Tray_interval * TaskI_Tokens) -Z(80) /4 CP
...
Function TaskI_Alignment_Block
	...
	Move XY(21, 40, -5.7, 0, 0, 0) +X(7) /2 CP
	Move XY(21, 40, -5.7, 0, 0, 0) +X(7) +Y(8) /2 CP
	Off 12
	Wait .05
    Move XY(21, 40, -3.7, 0, 0, 0) +X(6.5) +Y(7.5) -Z(8) /2 CP
	Move XY(21, 40, -3.7, 0, 0, 0) +X(2.2) +Y(1) -Z(8) /2 CP
	Go XY(21, 40, -3.7, 0, 0, 0) +X(2.2) +Y(1) -Z(2) /2
	On 12
	Wait .1
...
Function TaskI_Place_Tray_Block
    ...
    If TaskI_Blocks = 2 Then
    	Go XY(27.95, 26.5, -1, 91, 0, 0) +X(11.5) +Y(TaskI_Tray_interval * TaskI_Blocks) -Z(20) /4 CP
        Move XY(27.95, 26.5, -1, 91, 0, 0) +X(11.5) +Y(TaskI_Tray_interval * TaskI_Blocks) /4
        Off 12
        Wait .1
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(11.5) +Y(TaskI_Tray_interval * TaskI_Blocks) -Z(80) /4 CP

    ElseIf TaskI_Blocks = 1 Then
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(12.2) +Y(-0.5 + TaskI_Tray_interval * TaskI_Blocks) -Z(20) /4 CP
        Move XY(27.95, 26.5, -1, 91, 0, 0) +X(12.2) +Y(-0.5 + TaskI_Tray_interval * TaskI_Blocks) /4
        Off 12
        Wait .1
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(12.2) +Y(-0.5 + TaskI_Tray_interval * TaskI_Blocks) -Z(80) /4 CP

    ElseIf TaskI_Blocks = 0 Then
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(12.5) +Y(-1.5) -Z(20) /4 CP
        Move XY(27.95, 26.5, -1, 91, 0, 0) +X(12.5) +Y(-1.5) /4
        Off 12
        Wait .1
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(12.5) +Y(-1.5) -Z(80) /4 CP
...
Function TaskII_put_Block
    ...
    If TaskII_Blocks = 5 Then
	    Go XY(21, 40, -6.2, 0, 0, 0) -Z(15) /2
        Move XY(21, 40, -6.2, 0, 0, 0) /2
	    Off 12
	    Wait .05
	    Move XY(21, 40, -6.2, 0, 0, 0) -Z(8) /2 CP
	    
    ElseIf TaskII_Blocks <> 5 Then
        Go XY(20.5, 39, -6.5, 0, 0, 0) +X(2.5) +Y(1.5) -Z(8 + (5 - TaskII_Blocks) * TaskII_BlockHeight + (5 - TaskII_Tokens) * TaskII_TokenHeight) /2
	    Off 12
	    Wait .05
...
Function TaskII_put_Token
    ...
    Go XY(21, 40, -6.5, 0, 0, 0) +X(2.5) +Y(1.5) -Z(10 + (4 - TaskII_Blocks) * TaskII_BlockHeight + (5 - TaskII_Tokens) * TaskII_TokenHeight) /2
	Off 12
	Wait .05
...
Function TaskIII_I_Place_Tray_Token
    ...
    If TaskIII_I_Tokens = 2 Then
    	Go XY(11.95, 26.5, -1, 0, 0, 0) +X(-0.8) +Y(-1 + TaskIII_I_Tray_interval * TaskIII_I_Tokens) -Z(20) /4 CP
        Move XY(11.95, 26.5, -1, 0, 0, 0) +X(-0.8) +Y(-1 + TaskIII_I_Tray_interval * TaskIII_I_Tokens) /4
        Off 12
        Wait .5
        Go XY(11.95, 26.5, -1, 0, 0, 0) +X(-0.8) +Y(-1 + TaskIII_I_Tray_interval * TaskIII_I_Tokens) -Z(80) /4 CP
...
Function TaskIII_I_Place_Tray_Block
    ...
    If TaskIII_I_Blocks = 2 Then
    	Go XY(27.5, 26.5, -1, 91, 0, 0) +X(11.5) +Y(-0.25 + TaskIII_I_Tray_interval * TaskIII_I_Blocks) -Z(20) /4 CP
        Move XY(27.5, 26.5, -1, 91, 0, 0) +X(11.5) +Y(-0.25 + TaskIII_I_Tray_interval * TaskIII_I_Blocks) /4
        Off 12
        Wait .5
        Go XY(27.5, 26.5, -1, 91, 0, 0) +X(11.5) +Y(-0.25 + TaskIII_I_Tray_interval * TaskIII_I_Blocks) -Z(80) /4 CP

    ElseIf TaskIII_I_Blocks = 1 Then
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(11.7) +Y(-1.0 + TaskIII_I_Tray_interval * TaskIII_I_Blocks) -Z(20) /4 CP
        Move XY(27.95, 26.5, -1, 91, 0, 0) +X(11.7) +Y(-1.0 + TaskIII_I_Tray_interval * TaskIII_I_Blocks) /4
        Off 12
        Wait .5
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(11.7) +Y(-1.0 + TaskIII_I_Tray_interval * TaskIII_I_Blocks) -Z(80) /4 CP

    ElseIf TaskIII_I_Blocks = 0 Then
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(12.2) +Y(-1.5) -Z(20) /4 CP
        Move XY(27.95, 26.5, -1, 91, 0, 0) +X(12.2) +Y(-1.5) /4
        Off 12
        Wait .5
        Go XY(27.95, 26.5, -1, 91, 0, 0) +X(12.2) +Y(-1.5) -Z(80) /4 CP
...
Function TaskIO_put_Block
	...
	Print "Put Block. Block ID = ", TaskIO_Blocks
        ...
        Go XY(20.5, 38, -6.5, 0, 0, 0) +X(2.5) +Y(1.5) -Z(5 + (TaskIO_Blocks_number - TaskIO_Blocks) * TaskIO_BlockHeight) /2
	    Wait .25
	    Off 12
	    Wait .25
...
Function TaskIO_put_Token
    ...
    Go XY(21, 40, -6.5, 0, 0, 0) +X(2.5) +Y(1.5) -Z(2.5 + (TaskIO_Blocks_number - TaskIO_Blocks) * TaskIO_BlockHeight + (TaskIO_Tokens_number - TaskIO_Tokens) * TaskIO_TokenHeight) /2
	Wait .25
	Off 12
	Wait .25
